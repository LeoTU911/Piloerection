...
def matchingModelandPredictWeight(models_Predict_Weights_df):
    ...
    models_List = ['vit_base', 'vit_large', 'AlexNet', 'vgg16', 'vgg19', 'resnet50', 'resnet101']
...
def predictOnePart_fusion(frameFile_List, 
    ...
    vgg16     = createModel(model_Name='vgg16', models_Weights_Path=models_Weights_Path, num_classes=num_classes, device=device)
    vgg19     = createModel(model_Name='vgg19', models_Weights_Path=models_Weights_Path, num_classes=num_classes, device=device)
    resnet50  = createModel(model_Name='resnet50', models_Weights_Path=models_Weights_Path, num_classes=num_classes, device=device)
    resnet101 = createModel(model_Name='resnet101', models_Weights_Path=models_Weights_Path, num_classes=num_classes, device=device)
    
    model_List = [vit_base, vit_large, alexnet, vgg16, vgg19, resnet50, resnet101]
    ...
    del vit_base, vit_large, alexnet, vgg16, vgg19, resnet50, resnet101
...
def main(args):
    ...
    for videoFile in videoFile_List:
        ...
        print('{} prediction finished. The results saved in {}'.format(videoFile, predictionSavePath))
