...
from ViT_Model import vit_base_patch16_224 as create_model_base
from ViT_Model import vit_large_patch16_224 as create_model_large
...
def main(args):
    ...
    if args.model_name == 'vit_base':
        model = create_model_base(num_classes=args.num_classes, has_logits=False).to(device)
    elif args.model_name == 'vit_large':
        model = create_model_large(num_classes=args.num_classes, has_logits=False).to(device)
    else:
        assert args.model_name == 'vit_base' or args.model_name == 'vit_large', "model name should be 'vit_base' or 'vit_large'"
