...
# test5 = pd.read_csv('C:\\Users\\Sharp\\Downloads\\predict_070_dom arm.csv')
# test6 = pd.read_csv('D:\\downloads\\Piloerection\\testData\\file\\4-grid\\070_dom arm.csv')


# # Rename the columns
# new_names = {"time": "time", "1": "small", "3": "large"}
# test6 = test6.rename(columns=new_names)
...
#     pred_tmp =  test5.loc[i]
#     label_tmp = test6[test6['time'] == pred_tmp['time']]
