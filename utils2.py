...
def smoothResult(args):
    ...
    for file in file_List:
        ...
        # get the column
        column = pd.Series(data[args.column_name])
    
        # smooth
        smoothed_Column = column.rolling(window=args.smooth_window, center=True).mean()
        ...
        # save the new data
        # get the file's info
        file_Name = file_with_Path.split('.')[0]
        new_File  = '{}_smooth.csv'.format(file_Name) 
...
if __name__ == '__main__':
    ...
    # The file need to be smoothed
    parser.add_argument('--file_path',  type=str, default="./")
    # column name
    parser.add_argument('--column_name',  type=str, default="dissimilarity")
    # smooth window
